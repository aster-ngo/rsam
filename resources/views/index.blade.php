    ...
    <body>
        ...
        <div id="dialog-login-box" class="dialog">
            ...
            <form method="post" id="form-login" class="login-content" action="{{ url('/auth/login') }}" role="form" >
                ...
                <button class="button submit-button" style="margin-left: 0px;" type="submit">Đăng nhập</button>
                <span class="forgot" style="margin-top: -55px;margin-bottom: 30px;margin-left: 170px;" > 
