		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="vien_tham.html">Quản lý đặt hàng</a>
						<i class="fa fa-angle-right"></i>
					</li>
					<li>
						<a href="vien_tham.html">Đơn hàng yêu cầu</a>
					</li>
				</ul>
            ...
            <div class="row" >
                <form action="" role="form" class="form-horizontal" style="margin-left: 40px;margin-top: 30px">
                            ...
                            <div class="col-md-9">
                                <div class="input-inline input-medium">
                                    <div class="ql_droplist">
                                        <p><font size ="3">Trạng thái</font></p>
                                       <select name = "ql_tim_ve_tinh" id = "ql_tim_kiem" style="width:200px;height:30px">
                                            <option value ="tera">Còn hạn</option>
                                            <option value ="auqa">Không còn hạn</option>
                                            <option value ="npp">Đang xử lý</option>
                                            <option value ="other">Chưa xử lý</option>
                                       </select>
                                    </div>
                                </div>
                                <span class="help-inline">
					...
					<div class="portlet box blue" style="margin-left: 300px; margin-right: 30px;margin-top: -300px">
