...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="vien_tham.html">Quyền hạn</a>
        </li>
    </ul>
...
<div class="row">
    ...
    <div class="portlet box yellow">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-user"></i>Quyền hạn

            </div>
            <div class="actions">
                <a href="#" class="btn btn-default btn-sm">
                    <i class="fa fa-pencil"></i> Thêm quyền hạn</a>
                </div>
            </div>
        </div>
        <div class="portlet-body">
            <table class="table table-striped table-bordered table-hover" id= "tb_quyenhan">
                <thead>
                <tr>
                    <th>
                        Tên
                ...
                <tr class="odd gradeX">
                    ...
                    <td>
                        Chức năng hiển thị xem ảnh dữ liệu trên client
                    </td>
                    <td>
                ...
                <tr class="odd gradeX">
                    ...
                    <td>
                        Tải dữ liệu trên client dành cho những người có tài khoản
                    </td>
                    <td>
                ...
                <tr class="odd gradeX">
                    ...
                    <td>
                        ...
                        Chức năng báo cáo của Admin db
                    </td>
                    <td>
                ...
                <tr class="odd gradeX">
                    ...
                    <td>
                        ...
                        Chức năng quản lý người dùng trên hệ thống của Admin hệ thống
                    </td>
                    <td>
                ...
                <tr class="odd gradeX">
                    ...
                    <td>
                        ...
                        Chức năng quản dữ liệu của các Admin database
                    </td>
                    <td>
                ...
                <tr class="odd gradeX">
                    ...
                    <td>
                        ...
                        Xem báo cáo và quản lý các Admin database
                    </td>
                    <td>
