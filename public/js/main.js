	...
	! function(global) {
			...
			return w = {
				...
				callPlugin: function() {
					...
					this.depMaps.push(i), u(i, "defined", bind(this, function(i) {
						...
						})), c = getOwn(T, s.id), void(c && (this.depMaps.push(s), this.events.error && c.on("error", bind(this, function(e) {
							this.emit("error", e)
						})), c.enable()))) : h ? (this.map.url = x.nameToUrl(h), void this.load()) : (r = bind(this, function(e) {
							this.init([], function() {
								return e
							}, null, {
								enabled: !0
				...
				enable: function() {
					E[this.map.id] = this, this.enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, function(e, t) {
						var n, i, r;
						if ("string" == typeof e) {
							if (e = o(e, this.map.isDefine ? this.map : this.map.parentMap, !1, !this.skipMap), this.depMaps[t] = e, r = getOwn(w, e.id)) return void(this.depExports[t] = r(this));
			...
			Rt.optgroup = Rt.option, Rt.tbody = Rt.tfoot = Rt.colgroup = Rt.caption = Rt.thead, Rt.th = Rt.td, et.extend({
				...
				domManip: function(e, t) {
					...
					if (l && (n = et.buildFragment(e, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
						...
						if (s)
							for (a = r[r.length - 1].ownerDocument, et.map(r, p), u = 0; s > u; u++) o = r[u], $t.test(o.type || "") && !vt.access(o, "globalEval") && et.contains(a, o) && (o.src ? et._evalUrl && et._evalUrl(o.src) : et.globalEval(o.textContent.replace(Pt, "")))
					}
					return this
				}
			}), et.each({
				...
				style: function(e, t, n, i) {
					if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
						var r, s, o, a = et.camelCase(t),
							u = e.style;
						return t = et.cssProps[a] || (et.cssProps[a] = _(u, a)), o = et.cssHooks[t] || et.cssHooks[a], void 0 === n ? o && "get" in o && void 0 !== (r = o.get(e, !1, i)) ? r : u[t] : (s = typeof n, "string" === s && (r = Qt.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(et.css(e, t)), s = "number"), void(null != n && n === n && ("number" !== s || et.cssNumber[a] || (n += "px"), J.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), o && "set" in o && void 0 === (n = o.set(e, n, i)) || (u[t] = "", u[t] = n))))
					}
				},
		...
		function() {
			...
			function t(n, i) {
				...
				this.$element = e(e(n).is("body") ? window : n), this.$body = e("body"), this.$scrollElement = this.$element.on("scroll.bs.scroll-spy.data-api", s), this.options = e.extend({}, t.DEFAULTS, i), this.selector = (this.options.target || (r = e(n).attr("href")) && r.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a", this.offsets = e([]), this.targets = e([]), this.activeTarget = null, this.refresh(), this.process()
			}
			t.DEFAULTS = {
				offset: 10
				...
				e.cleanData = function(t) {
					...
					e.fn[n] = function(o) {
						var a = "string" == typeof o,
							...
							l = this;
						return o = !a && u.length ? e.widget.extend.apply(null, [o].concat(u)) : o, this.each(a ? function() {
		...
		function(e, t) {
			...
			t.Isotope.settings = {
				...
				_processStyleQueue: function(e, n) {
					var i, r, o, a, u = this.isLaidOut && this.isUsingJQueryAnimation ? "animate" : "css",
			...
			t.fn.isotope = function(e, n) {
				if ("string" == typeof e) {
					...
					this.each(function() {
						...
						return n ? t.isFunction(n[e]) && "_" !== e.charAt(0) ? void n[e].apply(n, i) : void _("no such method '" + e + "' for isotope instance") : void _("cannot call methods on isotope prior to initialization; attempted to call method '" + e + "'")
					})
				} else this.each(function() {
		...
		function(e, t, n) {
			...
			function() {
				e(".js--where-we-are").length < 1 || new i(e(".js--where-we-are"), {
